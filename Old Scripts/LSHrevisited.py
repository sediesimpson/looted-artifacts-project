...
# max_search_radius = 3
# query_vec = train_features[train_img_paths=='/rds/user/sms227/hpc-work/dissertation/data/duplicatedata/Αγγεία Αιγυπτιακά 32/Gorny & Mosch, Munich, 26_06_2018, Lot 436.8_11.jpg']

# all_neighbors = lsh.query2(query_vec, max_search_radius)

# "Gorny & Mosch, Munich, 26_06_2018, Lot 436.8_11.jpg"
...
# save_path = 'lshplotscorrected/query10LSH.png'
